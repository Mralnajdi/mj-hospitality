(async()=>{
  ...
  const productAssets=[
    '01-zill-shagra','02-zill-original','03-zill-ghamjah','04-air-ricardo','05-tres-dragones','06-pink-bourbon-punch','07-bourbon-sidra-sakura','08-ea-decaf-v2','09-ethiopia-finara','10-sencha-sleepless','11-moroccan-mint','12-japanese-cherry-v2','13-le-touareg','14-marani','15-jasmine-rolls','16-white-lemon-vanilla','17-white-jasmine','18-gourmet-herbal','19-mate-green','20-ginger-turmeric','21-one-for-all','22-chamomile','23-peach-melba','24-cherry-banana','25-berry-heaven','26-strawberry-moringa','27-passion-fruit','28-woodland-berries','29-seleco-cola','30-seleco-raspberry-lemon','31-rosemary-cucumber','32-hibiscus','33-raspberry-blackcurrant','34-cucumber-mint','35-fairview-premium','36-fairview-kaldi','37-java-house-kenya-aa','38-barista-gourmet'
  ];
  ...
  function setText(){
    ...
    const homeLabel=t('Home','الرئيسية'),brandBtn=document.getElementById('brandBtn');brandBtn.setAttribute('aria-label',homeLabel);brandBtn.title=homeLabel;
  ...
  function home(){
    const homeCategoryImages={arabic:'assets/home-v3/arabic-mj-natural.webp',specialty:'assets/home-v2/specialty-mj.webp',tea:'assets/home-v2/tea-mj.webp',sparkling:'assets/home-v2/sparkling-mj.webp'};
